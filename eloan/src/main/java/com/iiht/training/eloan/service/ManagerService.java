...
public interface ManagerService<LoanapprovalDTO, SanctionOutputDto, LoanOutputDto> {
	...
	public LoanapprovalDTO approvedLoan(Long loanamount, Long termpaymentamount );
}
